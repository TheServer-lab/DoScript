...
| [09-strings-and-text.md](09-strings-and-text.md) | `trim`, `lower`, `upper`, `replace`, `length`, and text-cleaning patterns |
| [10-safer-commands.md](10-safer-commands.md) | `execute_command`, shell safety, and when to use `run` |
| [11-whats-new-in-0.6.9.md](11-whats-new-in-0.6.9.md) | `else_if`, indexed loops, and the latest workflow improvements |
...
These materials cover **DoScript v0.6.9**.
