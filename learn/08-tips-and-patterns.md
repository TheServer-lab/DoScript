...
## else_if vs The moved Flag Pattern

In **DoScript v0.6.9+**, prefer `else_if` for ordinary condition chains:
...
The older `moved` flag pattern is still useful when you specifically want
multiple separate `if_ends_with` checks:
