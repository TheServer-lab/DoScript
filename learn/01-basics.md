...
Seven path variables are always available on every platform — no declaration
needed. They resolve to the correct location on Windows, macOS, and Linux.
...
Use these instead of hardcoded paths — scripts written with built-in path
variables work on any machine without editing.
