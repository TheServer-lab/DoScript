...
DoScript is released under the **Server-Lab Open-Control License (SOCL) 1.0**.
By contributing, you agree that your changes fall under the same license.

Please read [`LICENSE`](LICENSE) before submitting anything. If you're not comfortable with the terms, reach out before contributing so we can talk it through.
...
Hit the **Fork** button at the top of the [DoScript repository](https://github.com/TheServer-lab/DoScript) to create your own copy. This is where all your changes will live until they're ready to merge.
