...
- New: install_module <name> CLI subcommand -- downloads a .do module from TheServer-lab/DoModule on GitHub
  and installs it to C:\Program Files (x86)\DoScript\modules (Windows) or ~/DoScript/modules (Unix)
...
class DoScriptInterpreter:
    ...
    def _exec_statement(self, stmt: str) -> Optional[Tuple[str, Any]]:
        ...
        if stmt.startswith('use_module '):
            ...
            # Search order:
            #   1. Global install dir  (C:\Program Files (x86)\DoScript\modules)
...
def _get_module_install_dir() -> str:
    ...
    if sys.platform == "win32":
        return r"C:\Program Files (x86)\DoScript\modules"
    else:
...
def _print_help():
    ...
    print("  --dir <path>  Override the install directory (default: Program Files/DoScript/modules)")
    print()
