...
# 'appdata' is a built-in: AppData/Roaming on Windows, ~/.config on Linux/macOS
SETTINGS_FILE = '{appdata}/MyApp/settings.json'
APP_NAME      = "MyApp"
...
# 'username' is a built-in — defaults to the OS login name
